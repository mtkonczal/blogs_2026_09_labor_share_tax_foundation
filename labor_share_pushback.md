...
![Figure 1. The Tax Foundation's own "unambiguous" labor share, every quarter since 1947](output/figures/blogpost/figure1_tf_share_quarterly.png)
...
![Figure 2. Their measure with 0%, 50%, and 100% of proprietors' income counted as labor](output/figures/blogpost/figure2_proprietor_0_50_100_quarterly.png)
...
![Figure 3. The nonfinancial corporate net labor share against its own 1947-49 average](output/figures/blogpost/figure3_not_without_precedent_quarterly.png)
...
**Fifth**, building on that, labor share actually mirrors 1% inequality this way. Using the annual data again, take the capital share of net income and put it up against Piketty and Saez’s own top 1% share of *wage* income — no capital income in it at all, so there’s no overlap with what’s on the other axis — from their updated tables (which stop being maintained in 2011), and take a look (Figure 5):

![Figure 5. The capital share and top-1% income concentration move together](output/figures/blogpost/figure5_top1_vs_capital.png)

It’s the same story? Different decades along the way, but the two series correlate at r = 0.61 in levels over the 1929-2011 overlap. Year-to-year changes barely correlate (r = 0.05) — this is a decades-long comovement, not a tight annual one. I think we have a story that 1% inequality has largely been a choice we’ve made, though obviously many people argue it’s strictly a matter of supply and demand. We certainly don’t, in the back of our heads, think that the 1% share is fixed deep in the economy. Perhaps it’s time we think the same thing with the capital share.