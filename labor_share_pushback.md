...
FIGURE1TK AI NEW GRAPHIC HERE TKTKTKTK THAT’S JUST THEIR SHARE WHOLE QUARTERLY PERIOD AI TKTKTKTK
...
**Second**, if you include proprietary income as labor income for their measure, then it becomes the lowest on record. Let’s stick with their measure, and add in some proprietary income as labor income. Their post is in a bind, because it wants to argue, following the latest evidence, that we should think of prop income as being mostly labor income, on the order of three-quarters ([Smith et al 2019](https://www.nber.org/papers/w25442)), to try and talk up hidden labor income currently. But if you do that, given the higher share of prop income in the 1940s, it raises the labor share then. Here it their measure with 0%, 50%, and 100% of prop income as labor income:

TKTKTK AI FIGURE 2 DOING WHAT IT SAYS ABOVE TKTKTKTK.

Their original measure was really dependent on a handful of quarterly data points in the late 1940s. The drop is noticeable even considering that. Sticking with their unambiguous labor share measure, the average in the 21st century TKAI USE QUARTERLY HERETKTK (2000-2025) is 70.8%, which is below the 73.9% average from 1950 to 2000. But adding any prop income over measure the labor share is higher now, but also more historically lower, actually the lowest on level. This alone shuts down their round trip argument but I want to keep going.

**Third**, the round trip language piggybacks off a staple of the labor share literature debates of the 2010s, which is that net share is back to earlier historical ranges. As (LINKTKGROSSMAN2022) says, echoing the third item at the beginning: "The gross labor share was relatively stable through 2000, but then declined to a level below its historical range. In contrast, as noted by Bridgman (2018) and Rognlie (2015), the net labor share had been rising between 1940 and 1980, so the recently lower level is not without precedent."

That was definitely true in 2015 and 2018. Here’s the two measures I watch most closely, TKTK DESCRIPTION AI TKTKTK this is now different than what the Tax Foundation uses, which is TK:

AITKTKTKT GRAPHIC NET NONFINANCIAL BUT ALSO TOTAL WITH 50% PROP TKTKTKTKT
